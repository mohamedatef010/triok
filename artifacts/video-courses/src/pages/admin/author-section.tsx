...
const DEFAULT_DATA: AuthorSectionData = {
  ...
  heading: "Как видеомонтаж стал ремеслом всей жизни",
  subheading: "От первого склеенного кадра в 2014 года до создания обучающей системы для тысяч учеников",
  quote: "Всем доброго времени суток, занимаюсь видеомонтажом около 10 лет. Готов смонтировать пробный ролик с ваших исходников до 5 мин. бесплатно) Это не моя постоянная деятельность, а как творческое увлечение. Жду ваших предложений",
  authorName: "Максим Берестнев",
  authorTitle: "Монтаж рекламных роликов, YouTube, клипов и Shorts",
  photoUrl: "",
  photoMediaType: "image",
  backgroundPhotoUrl: "/n13.jpg",
  chapters: [
    { label: "Глава 1", heading: "2014 — Первые шаги и поиск стилистики", text: "Начинал с самостоятельного изучения Premiere Pro и сложных туториалов. Монтировал первое видео более 40 часов, чтобы довести каждый переход до идеала." },
    { label: "Глава 2", heading: "2018 — Коммерческие проекты и Топ-блогеры", text: "Перешел в сферу коммерческого видео: реклама брендам, музыкальные клипы, влоги и динамичные трейлеры. Смонтировал более 500+ крупных проектов." },
    { label: "Глава 3", heading: "2024 — Авторская программа & Сообщество", text: "Создал пошаговую практическую методологию обучения. Без сухой теории — только реальные рабочие исходники, готовые плагины и секреты быстрого монтажа." },
  ],
  skills: ["Adobe Premiere Pro", "DaVinci Resolve", "After Effects", "Цветокоррекция", "Саунд-дизайн", "Shorts & Reels"],
  socialLinks: {
    telegram: "",
    whatsapp: "",
    instagram: "",

...
export function TermsPage() {
  ...
  useSEO({
    ...
    description: "Договор публичной оферты на приобретение доступа к цифровым обучающим материалам на платформе Классный Фокус.",
    canonical: "/terms",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Публичная оферта — Классный Фокус",
      "description": "Условия публичного договора-оферты на предоставление доступа к цифровым обучающим видео.",
    ...
    <div className="container mx-auto max-w-4xl px-4 py-12 flex-1 overflow-hidden">
      <div className="mb-12 text-center">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed max-w-2xl mx-auto text-sm sm:text-base">
          Договор-оферта на предоставление электронного доступа к цифровым образовательным и обучающим видеоматериалам на платформе «Классный Фокус»
        </p>
      </div>
      ...
      <div className="space-y-10 text-foreground/90 leading-relaxed bg-card p-6 sm:p-10 rounded-3xl border shadow-sm">
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            1.2. Полным и безоговорочным принятием (акцептом) настоящей публичной оферты в соответствии со статьей 438 ГК РФ признается совершение Пользователем любого из действий: регистрация на сайте, оформление заказа или оплата выбранного обучения на сайте <strong>классный-фокус.рф</strong>.
          </p>
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
        ...
        <section className="space-y-3 border-t border-border/60 pt-8">
          ...
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            3.1. Пользователь самостоятельно знакомится с описанием, программой и стоимостью материалов в каталоге сайта и оформляет заказ через интерфейс корзины / страницы урока.
          </p>
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
        ...
        <section className="space-y-3 border-t border-border/60 pt-8">
          ...
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            4.1. Стоимость обучающих материалов указывается в рублях РФ (₽) на соответствующих страницах каталога и включает все применимые налоги.
          </p>
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
        ...
        <section className="space-y-3 border-t border-border/60 pt-8">
          ...
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            5.1. Все видеоуроки, текстовые описания, методики, графика и дизайн сайта являются объектами интеллектуальной собственности Исполнителя и защищены законодательством РФ об авторском праве.
          </p>
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            5.2. Пользователю предоставляется право личного некоммерческого просмотра материалов. Запрещается копирование, запись экрана, распространение, передача логина и пароля третьим лицам, публичный показ или перепродажа материалов.
          </p>
        </section>
        ...
        <section className="space-y-3 border-t border-border/60 pt-8">
          ...
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            6.2. Если по технической вине Исполнителя доступ к оплаченному обучению не был предоставлен и проблема не была устранена в разумный срок, Пользователь вправе потребовать возврата денежных средств.
          </p>
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">

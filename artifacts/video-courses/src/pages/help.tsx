...
export function HelpPage() {
  ...
  useSEO({
    ...
    description: "Ответы на вопросы об оплате, доступе к обучению, возврате средств и использовании учебных материалов на платформе Классный Фокус.",
    canonical: "/help",
    structuredData: {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Как получить доступ к обучению?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "После успешной оплаты выбранного фокуса доступ к учебным материалам предоставляется в вашем Личном кабинете на сайте. Вы сможете просматривать видеоуроки и другие материалы онлайн с компьютера, планшета или мобильного устройства."
          }
        },
        {
          "@type": "Question",
          "name": "Как можно оплатить обучение?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Оплата обучения осуществляется онлайн через защищённую платёжную систему ЮKassa. Вы можете использовать банковскую карту или другие способы, предоставляемые платёжной системой."
          }
        },
        {
          "@type": "Question",
          "name": "Как я получу обучающие материалы?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Видеоуроки и материалы являются цифровым контентом, физическая доставка не осуществляется. После подтверждения оплаты доступ к приобретённому обучению предоставляется в Личном кабинете пользователя."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Если после оплаты по техническим причинам доступ к приобретённому обучению не был предоставлен, пожалуйста, свяжитесь с нами. Каждое обращение рассматривается индивидуально."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Если после оплаты вы не видите приобретённое обучение в Личном кабинете или столкнулись с технической проблемой, свяжитесь с поддержкой по электронной почте: cool-trick@mail.ru"
          }
        }
      ]
    }
    ...
    <div className="container mx-auto max-w-4xl px-4 py-12 overflow-hidden">
      <div className="mb-10 text-center">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed max-w-2xl mx-auto">
          ...
          оплате, доступе к урокам и использовании материалов сайта.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <AccordionContent className="text-muted-foreground pb-6 leading-relaxed">
            После успешной оплаты выбранного видео доступ к учебным материалам
            предоставляется в вашем Личном кабинете на сайте. Вы сможете
            просматривать видеоуроки и другие материалы онлайн с
        ...
        >
          ...
          <AccordionContent className="text-muted-foreground pb-6 leading-relaxed">
            Оплата обучения осуществляется онлайн через защищённую платёжную
        ...
        >
          <AccordionTrigger className="hover:no-underline text-lg font-semibold py-6">
            Как я получу обучающие материалы?
          </AccordionTrigger>

          <AccordionContent className="text-muted-foreground pb-6 leading-relaxed">
            Уроки и инструкции являются цифровыми материалами,
            поэтому физическая доставка не осуществляется.
            <br />
            <br />
            После подтверждения оплаты доступ к приобретённым урокам
            предоставляется в Личном кабинете пользователя. Вы сможете
            открыть видео и начать обучение непосредственно на сайте.
          </AccordionContent>
        </AccordionItem>
        ...
        >
          ...
          <AccordionContent className="text-muted-foreground pb-6 leading-relaxed">
            ...
            обучению не был предоставлен или возникла проблема с доступом к
        ...
        >
          ...
          <AccordionContent className="text-muted-foreground pb-6 leading-relaxed">
            Приобретая доступ к обучающим материалам на
